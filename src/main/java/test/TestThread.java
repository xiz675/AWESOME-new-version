...
public class TestThread implements Runnable{
    ...
    public TestThread(LinkedBlockingQueue<List<Integer>> data, List<Integer> result, CountDownLatch... producers) {
        mode = "in";
        streamInput = data;
    ...
    public TestThread(List<Integer> data, LinkedBlockingQueue<List<Integer>> result) {
        mode = "out";
    ...
    public TestThread(LinkedBlockingQueue<List<Integer>> data, LinkedBlockingQueue<List<Integer>> result, CountDownLatch... producers) {
        mode = "pipeline";
        streamInput = data;
        streamResult = result;
        if (producers.length > 0) {
    ...
    public TestThread(List<Integer> data, List<Integer> result) {
        mode = "block";
        materializedInput = data;
    ...
    private void executeStreamOutput() {
        ...
        try {
            ...
            System.out.println("TestThread countdown:" + getLatch().getCount());
            countDown();
