...
import edu.sdsc.queryprocessing.planner.logicalplan.DAGElements.Nodes.Functions.CreateHistogram;
...
public class CreateHistogramPhysical extends FunctionPhysicalOperator{
    public CreateHistogramPhysical(CreateHistogram ch) {
